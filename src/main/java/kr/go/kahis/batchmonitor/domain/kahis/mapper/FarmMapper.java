package kr.go.kahis.batchmonitor.domain.kahis.mapper;

import java.util.List;
import kr.go.kahis.batchmonitor.domain.kahis.dto.FarmIdDplDto;
import kr.go.kahis.batchmonitor.domain.kahis.dto.FarmIdLsfarmDto;
import kr.go.kahis.batchmonitor.domain.kahis.dto.FarmInfoDto;
import kr.go.kahis.batchmonitor.domain.kahis.dto.FarmScaleDetailDto;
import kr.go.kahis.batchmonitor.domain.kahis.dto.FarmScaleDto;
