...
> SMS 알림 발송(`NotificationConsumer`, `error-notification` 토픽)은 미구현입니다.
```
...
> `NotificationConsumer`, `error-notification` 토픽은 아직 구현되지 않았습니다.
...
### 4.10 NotificationConsumer (TODO)
